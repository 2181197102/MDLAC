import pandas as pd
from jdapp.models import JdGood

# python manage.py shell
#
# from jdapp.import_csv import run
# run()
...
def run():
    # 绝对路径
    csv_file_path = 'D:\\course\\intern\\MDLAC-master\\MDLAC\\dataset\\jd_goods.csv'
